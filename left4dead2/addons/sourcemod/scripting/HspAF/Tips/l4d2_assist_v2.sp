...
public OnPluginStart()
{
	...
	cvar_AssistEnable = CreateConVar("sm_assist_enable", "1", "开启/关闭插件.", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	cvar_AssistSI = CreateConVar("sm_assist_si", "0", "展示的SI伤害报告 (0: 只有Tank, 1: 除Tank外的所有感染者, 2: 所有感染者)", FCVAR_PLUGIN, true, 0.0, true, 2.0);
	cvar_AssistWitch = CreateConVar("sm_assist_witch", "1", "1: 展示witch伤害报告, cr0wn, who startled, remaining health, 0: 关闭", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	cvar_Frags = CreateConVar("sm_assist_frags", "1", "1: 在回合结束时显示Tank剩余生命值, 0:关闭", FCVAR_PLUGIN, true, 0.0, true, 1.0);
