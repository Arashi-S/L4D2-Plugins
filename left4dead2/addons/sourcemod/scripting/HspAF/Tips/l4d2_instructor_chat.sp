...
public void OnPluginStart() {
	...
	cIcon =		CreateConVar(PLUGIN_NAME ... "_icon", "icon_info",		"instructor hint icon, more see ./pak01_dir.vpk/scripts/mod_textures.txt", FCVAR_NOTIFY);
	cColor =	CreateConVar(PLUGIN_NAME ... "_color", "255,182,193",	"instructor hint color, RBG format", FCVAR_NOTIFY);
