...
public void OnPluginStart() {
	...
	Enable =					CreateConVar("killing_adrenaline_enable", "1", "插件启用", FCVAR_NOTIFY);
	Adrenaline_duration_base =	CreateConVar("killing_adrenaline_duration_base", "0.33", "杀死一只普通丧尸增加的时间", FCVAR_NOTIFY, true, 0.1);
	Adrenaline_headshot_ratio =	CreateConVar("killing_adrenaline_headshot_ratio", "1.5", "爆头击杀时间增加乘数", FCVAR_NOTIFY, true, 0.0);

	Adrenaline_distance_max =	CreateConVar("killing_adrenaline_distance_max", "1200", "多远距离算远距击杀", FCVAR_NOTIFY, true, 220.0);
	Adrenaline_distance_ratio =	CreateConVar("killing_adrenaline_distance_ratio", "1.5", "如果达成远距击杀，则时间乘数*1.5，近距击杀为*1", FCVAR_NOTIFY, true, 1.0);

	Adrenaline_piped_ratio =	CreateConVar("killing_adrenaline_piped_ratio", "0.85", "土制炸弹击杀时间乘数", FCVAR_NOTIFY, true, 0.0);
	Adrenaline_melee_ratio =	CreateConVar("killing_adrenaline_melee_ratio", "1.16", "近战击杀时间乘数", FCVAR_NOTIFY, true, 0.0);
	Adrenaline_grenade_ratio =	CreateConVar("killing_adrenaline_grenade_ratio", "0.75", "榴弹发射器杀伤持续时间乘数", FCVAR_NOTIFY, true, 0.0);

	Adrenaline_tank_ratio =		CreateConVar("killing_adrenaline_tank_ratio", "2.0", "坦克持续时间乘数", FCVAR_NOTIFY, true, 0.0);
	Adrenaline_witch_ratio =	CreateConVar("killing_adrenaline_witch_ratio", "2.0", "witch持续时间乘数", FCVAR_NOTIFY, true, 0.0);

	Adrenaline_boomer_ratio =	CreateConVar("killing_adrenaline_boomer_ratio", "1.33", " boomer持续时间乘数", FCVAR_NOTIFY, true, 0.0);
	Adrenaline_smoker_ratio =	CreateConVar("killing_adrenaline_smoker_ratio", "1.33", " smoker持续时间乘数", FCVAR_NOTIFY, true, 0.0);
	Adrenaline_hunter_ratio =	CreateConVar("killing_adrenaline_hunter_ratio", "1.25", " hunter持续时间乘数", FCVAR_NOTIFY, true, 0.0);
	Adrenaline_spitter_ratio =	CreateConVar("killing_adrenaline_spitter_ratio", "1.2", " spitter持续时间乘数", FCVAR_NOTIFY, true, 0.0);
	Adrenaline_jockey_ratio =	CreateConVar("killing_adrenaline_jockey_ratio", "1.25", " jockey持续时间乘数", FCVAR_NOTIFY, true, 0.0);
	Adrenaline_charger_ratio =	CreateConVar("killing_adrenaline_charger_ratio", "1.5", " charger持续时间乘数", FCVAR_NOTIFY, true, 0.0);

	Adrenaline_allow_cooling =	CreateConVar("killing_adrenaline_allow_cooling", "0", "即使没有肾上腺素也允许通过击杀获得效果？", FCVAR_NOTIFY, true, 0.0);
	Adrenaline_allow_bot =		CreateConVar("killing_adrenaline_allow_bot", "1", "是否允许bot也获得效果", FCVAR_NOTIFY, true, 0.0);
	Adrenaline_pills_gain =		CreateConVar("killing_adrenaline_pills_gain", "0", "also gain adrenaline when use pain pills, 0.5: half of ConVar 'adrenaline_duration' 0: disable", FCVAR_NOTIFY, true, 0.0);
	Adrenaline_duration_full =	FindConVar("adrenaline_duration");
	Adrenaline_combo_time =		CreateConVar("killing_adrenaline_combo_time", "0", "combo time, between prev kill mean you make a combo, -1: same as 'duration_base', 0: disable combo", FCVAR_NOTIFY, true, -1.0);
