...
public void OnPluginStart()
{
	...
	g_hCvarModes = CreateConVar(	"l4d_skip_intro_modes",			"",				"在这些游戏模式中打开插件，以逗号分隔（无空格）。 （留空=全部）.", CVAR_FLAGS );
	g_hCvarModesOff = CreateConVar(	"l4d_skip_intro_modes_off",		"",				"在这些游戏模式中关闭插件，以逗号分隔（无空格）。 （留空 = 无）.", CVAR_FLAGS );
	g_hCvarModesTog = CreateConVar(	"l4d_skip_intro_modes_tog",		"0",			"在这些游戏模式中打开插件。 0=全部，1=合作，2=生存，4=对抗，8=清道夫。 可将数字相加.", CVAR_FLAGS );
