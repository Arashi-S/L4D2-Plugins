...
public void OnPluginStart()
{
    ...
    g_hCvar_Bots    = CreateConVar("l4d_car_alarm_vomit_bots", "0", "Enables/Disables the plugin behaviour on Survivor bots.\n0 = OFF, 1 = ON.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_Flags   = CreateConVar("l4d_car_alarm_vomit_flags", "z", "Players with these flags are immune to the plugin behaviour.\nEmpty = none.\nKnown values at \"\\addons\\sourcemod\\configs\\admin_levels.cfg\".\nExample: \"az\", will apply immunity to players with \"a\" (reservation) or \"z\" (root) flag.", CVAR_FLAGS);
