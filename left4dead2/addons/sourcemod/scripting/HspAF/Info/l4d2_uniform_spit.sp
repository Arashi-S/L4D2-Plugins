...
public void OnPluginStart()
{
	...
	g_hCvarDamagePerTick = CreateConVar("l4d2_spit_dmg", "-1.0", "spit每刻造成的伤害，-1=插件不做调整");
	g_hCvarAlternateDamagePerTwoTicks = CreateConVar("l4d2_spit_alternate_dmg", "-1.0", "fw翻译官不知道怎么翻译：Damage per alternate tick. -1 to disable");
	g_hCvarMaxTicks = CreateConVar("l4d2_spit_max_ticks", "28", "fw翻译官不知道怎么翻译：Maximum number of acid damage ticks");
	g_hCvarGodframeTicks = CreateConVar("l4d2_spit_godframe_ticks", "4", "fw翻译官不知道怎么翻译：Number of initial godframed acid ticks");
