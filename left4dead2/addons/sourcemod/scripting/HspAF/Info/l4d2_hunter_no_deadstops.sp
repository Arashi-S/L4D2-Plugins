...
public void OnPluginStart()
{
	...
	cvarHunterGroundM2Godframes = CreateConVar("hunter_ground_m2_godframes", "0.75", "hunter落地后的停顿时间？？？（原注释为：m2 godframes after a hunter lands on the ground）", _, true, 0.0, true, 1.0);
}
