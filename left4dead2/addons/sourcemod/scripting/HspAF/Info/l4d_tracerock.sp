...
public OnPluginStart()
{
 	...
 	l4d_tracerock_chance = 	CreateConVar("l4d_tracerock_chance", "90", "the chance of trace of rock [0-100](int)");	
	l4d_tracerock_speed = 	CreateConVar("l4d_tracerock_speed", "650", "trace rock 's speed");	
...
{ 
	...
	if(enemy>0)	
	{
		...
		if(ShowMsg)
		{
			...
			{
				PrintHintText(enemy, "注意，你被Tank的饼锁定了, 距离你: %d", RoundFloat(disenemy) );
