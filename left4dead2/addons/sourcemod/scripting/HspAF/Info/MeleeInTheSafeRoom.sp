...
public OnPluginStart()
{
    ...
    g_hEnabled              = CreateConVar( "l4d2_MITSR_Enabled",       "1", "是否应启用插件"); 
    g_hWeaponRandom         = CreateConVar( "l4d2_MITSR_Random",        "1", "生成随机武器（1）或自定义列表（0）"); 
    g_hWeaponRandomAmount   = CreateConVar( "l4d2_MITSR_Amount",        "2", " l4d2_MITSR_Random 值为 1 时 生成的武器数量"); 
    g_hWeaponBaseballBat    = CreateConVar( "l4d2_MITSR_BaseballBat",   "1", " 棒球棒  数量在 (l4d2_MITSR_Random 值为 0 时)");
    g_hWeaponCricketBat     = CreateConVar( "l4d2_MITSR_CricketBat",    "1", " 板球棒  数量在 (l4d2_MITSR_Random 值为 0 时)");
    g_hWeaponCrowbar        = CreateConVar( "l4d2_MITSR_Crowbar",   "1", " 撬棍 数量在 (l4d2_MITSR_Random 值为 0 时)");
    g_hWeaponElecGuitar     = CreateConVar( "l4d2_MITSR_ElecGuitar",    "1", " 电吉他 数量在 (l4d2_MITSR_Random 值为 0 时)");
    g_hWeaponFireAxe            = CreateConVar( "l4d2_MITSR_FireAxe",       "1", " 消防斧 数量在 (l4d2_MITSR_Random 值为 0 时)");
    g_hWeaponFryingPan      = CreateConVar( "l4d2_MITSR_FryingPan", "1", " 平底锅 数量在 (l4d2_MITSR_Random 值为 0 时)");
    g_hWeaponGolfClub       = CreateConVar( "l4d2_MITSR_GolfClub",  "1", " 高尔夫球杆 数量在 (l4d2_MITSR_Random 值为 0 时)");
    g_hWeaponKnife          = CreateConVar( "l4d2_MITSR_Knife",     "1", " 小刀 数量在 (l4d2_MITSR_Random 值为 0 时)");
    g_hWeaponKatana         = CreateConVar( "l4d2_MITSR_Katana",        "1", " 武士刀 数量在 (l4d2_MITSR_Random 值为 0 时)");
    g_hWeaponMachete            = CreateConVar( "l4d2_MITSR_Machete",       "1", " 开山刀 数量在 (l4d2_MITSR_Random 值为 0 时)");
    g_hWeaponRiotShield     = CreateConVar( "l4d2_MITSR_RiotShield",    "1", " 防暴盾牌 数量在 (l4d2_MITSR_Random 值为 0 时)");
    g_hWeaponTonfa          = CreateConVar( "l4d2_MITSR_Tonfa",     "1", "  在 (l4d2_MITSR_Random 值为 0 时)产生的数量？（原注释为Number of tonfas to spawn）");
