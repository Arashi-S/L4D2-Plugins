...
public void OnPluginStart()
{
	...
	g_hItemCvarColor		= CreateConVar("l4d2_item_hint_glow_color", "187 255 255", "物品发光颜色 (无内容 = 关闭发光)", FCVAR_NOTIFY);
	g_hItemInstructorHint	= CreateConVar("l4d2_item_instructorhint_enable", "1", "在物品上方显示物品提示 (0:禁用, 1启用)", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	g_hItemInstructorColor	= CreateConVar("l4d2_item_instructorhint_color", "0 245 255", "物品上方提示的颜色", FCVAR_NOTIFY);
	g_hItemInstructorIcon	= CreateConVar("l4d2_item_instructorhint_icon", "icon_info", "物品上方提示的图标 (更多图标: https://developer.valvesoftware.com/wiki/Env_instructor_hint)", FCVAR_NOTIFY);
	...
	g_hSpotMarkAnnounceType		= CreateConVar("l4d2_spot_marker_announce_type", "1", "标记提示的方式 (0:禁用, 1:聊天框, 2:弹出提示, 3:屏幕中心)", FCVAR_NOTIFY, true, 0.0, true, 3.0);
	g_hSpotMarkGlowTimer		= CreateConVar("l4d2_spot_marker_duration", "10.0", "标记持续时间", FCVAR_NOTIFY, true, 0.0);
	g_hSpotMarkCvarColor		= CreateConVar("l4d2_spot_marker_color", "191 62 255", "标记颜色 (无内容 = 关闭颜色)", FCVAR_NOTIFY);
	...
	g_hSpotMarkInstructorColor	= CreateConVar("l4d2_spot_marker_instructorhint_color", "255 192 203", "标记上方提示的颜色", FCVAR_NOTIFY);
	...
	g_hInfectedMarkUseRange     = CreateConVar("l4d2_infected_marker_use_range", "2500", "玩家多远可以标记特殊感染者", FCVAR_NOTIFY, true, 1.0);
	...
	g_hInfectedMarkGlowTimer   	= CreateConVar("l4d2_infected_marker_glow_timer", "15.0", "特殊感染者标记的持续时间", FCVAR_NOTIFY, true, 0.0);
	g_hInfectedMarkGlowRange   	= CreateConVar("l4d2_infected_marker_glow_range", "2500", "特殊感染者可视的最大距离", FCVAR_NOTIFY, true, 0.0);
	g_hInfectedMarkCvarColor   	= CreateConVar("l4d2_infected_marker_glow_color", "240 255 255", "特殊感染者标记颜色 （无内容=禁用特殊感染者发光）", FCVAR_NOTIFY);
...
void CreateStringMap()
{
	...
	g_smModelToName.SetString("models/w_models/weapons/w_eq_defibrillator.mdl", "电鸡器!");
	...
	g_smModelToName.SetString("models/w_models/weapons/w_laser_sights.mdl", "激光盒!");
	...
	g_smModelToName.SetString("models/props_junk/gnome.mdl", "人形回血器!");
	g_smModelToName.SetString("models/w_models/weapons/w_cola.mdl", "可乐!");
	g_smModelToName.SetString("models/w_models/weapons/50cal.mdl", ".50机枪!");
	g_smModelToName.SetString("models/w_models/weapons/w_minigun.mdl", "转轮机枪!");
	...
	g_smModelToName.SetString("models/weapons/melee/w_shovel.mdl", "粪叉子!");
