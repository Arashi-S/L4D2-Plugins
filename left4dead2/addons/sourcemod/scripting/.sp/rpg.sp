...
//	LoadTranslations("menu_shop.phrases.txt");
	...
	g_cShopEnable =  CreateConVar("shop_enable", "1", "是否打开商店购买", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	AllowBigGun = CreateConVar("rpg_allow_biggun", "0", "商店是否允许购买大枪", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	g_hEnableGlow = CreateConVar("rpg_allow_glow", "0", "商店是否打开轮廓", FCVAR_NOTIFY, true, 0.0, true, 1.0);
