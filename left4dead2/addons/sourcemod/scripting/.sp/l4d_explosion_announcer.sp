...
public void OnPluginStart()
{
    ...
    g_hCvar_Team               = CreateConVar("l4d_explosion_announcer_team", "1", "Boom消息发送给那些团队. 0=没有, 1=幸存者, 2=感染者, 4=旁观者, 8=幸存者NPC. 如需启用多个把数字加起来. 例如: 3=幸存者+感染者.", CVAR_FLAGS, true, 0.0, true, 15.0);
    g_hCvar_Self               = CreateConVar("l4d_explosion_announcer_self", "1", "Boom消息发送给点燃或引爆者?. 0=关闭, 1=开启.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_Gascan             = CreateConVar("l4d_explosion_announcer_gascan", "1", "启用幸存者引燃汽油桶Boom? 0=关闭, 1=开启.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_FuelBarrel         = CreateConVar("l4d_explosion_announcer_fuelbarrel", "1", "启用幸存者打爆白色大油桶Boom? 0=关闭, 1=开启.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_PropaneCanister    = CreateConVar("l4d_explosion_announcer_propanecanister", "1", "启用幸存者打爆煤气罐Boom? 0=关闭, 1=开启.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_OxygenTank         = CreateConVar("l4d_explosion_announcer_oxygentank", "1", "启用幸存者打爆氧气罐Boom? 0=关闭, 1=开启.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_BarricadeGascan    = CreateConVar("l4d_explosion_announcer_barricadegascan", "1", "启用幸存者引燃路障油桶Boom? 0=关闭, 1=开启.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_GasPump            = CreateConVar("l4d_explosion_announcer_gaspump", "1", "启用幸存者打爆汽油泵Boom? 0=关闭, 1=开启.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_OilDrumExplosive   = CreateConVar("l4d_explosion_announcer_oildrumexplosive", "1", "启用幸存者打爆(自定义)大油桶Boom? 0=关闭, 1=开启.", CVAR_FLAGS, true, 0.0, true, 1.0);
    if (g_bL4D2)
        g_hCvar_FireworksCrate = CreateConVar("l4d_explosion_announcer_fireworkscrate", "1", "启用幸存者点燃烟花盒Boom? 0=关闭, 1=开启.", CVAR_FLAGS, true, 0.0, true, 1.0);
    ...
    switch (type)
    {
        case TYPE_GASCAN:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                PrintToChat(client, "\x04[Boom]\x03%N\x05引燃了汽油桶!", attacker);
            }
        }
        ...
        case TYPE_FUEL_BARREL:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                PrintToChat(client, "\x04[Boom]\x03%N\x05打爆了大油桶!", attacker);
            }
        }
        ...
        case TYPE_PROPANECANISTER:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                PrintToChat(client, "\x04[Boom]\x03%N\x05打爆了煤气罐!", attacker);
            }
        }
        ...
        case TYPE_OXYGENTANK:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                PrintToChat(client, "\x04[Boom]\x03%N\x05打爆了氧气瓶!", attacker);
            }
        }
        ...
        case TYPE_BARRICADE_GASCAN:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                PrintToChat(client, "\x04[Boom]\x03%N\x05引燃了路障油桶!", attacker);
            }
        }
        ...
        case TYPE_GAS_PUMP:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                PrintToChat(client, "\x04[Boom]\x03%N\x05成为了加油站毁灭者!", attacker);
            }
        }
        ...
        case TYPE_FIREWORKS_CRATE:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                PrintToChat(client, "\x04[Boom]\x03%N\x05点燃了烟花盒!", attacker);
            }
        }
        ...
        case TYPE_OIL_DRUM_EXPLOSIVE:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                PrintToChat(client, "\x04[Boom]\x03%N\x05打爆了爆炸大油桶!", attacker);
            }
        }
    }
}
